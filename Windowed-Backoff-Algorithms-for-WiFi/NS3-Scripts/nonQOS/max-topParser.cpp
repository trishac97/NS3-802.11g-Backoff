...
for (int i = 0; i < 30; i++){
	...
	std::ifstream infile;
        ...
        if(i==0)
	{
          infile.open ("log1.txt");
        }
	if(i==1){
	  infile.open ("log2.txt");
	}
	if(i==2){
	  infile.open ("log3.txt");
	}
	if(i==3){
	  infile.open ("log4.txt");
	}
	if(i==4){
	  infile.open ("log5.txt");
	}
	if(i==5){
	  infile.open ("log6.txt");
	}
	if(i==6){
	  infile.open ("log7.txt");
	}
	if(i==7){
	  infile.open ("log8.txt");
	}
	if(i==8){
	  infile.open ("log9.txt");
	}
	if(i==9){
	  infile.open ("log10.txt");
	}
	...
	if(i==10)
	{
          infile.open ("log11.txt");
        }
	if(i==11){
	  infile.open ("log12.txt");
	}
	if(i==12){
	  infile.open ("log13.txt");
	}
	if(i==13){
	  infile.open ("log14.txt");
	}
	if(i==14){
	  infile.open ("log15.txt");
	}
	if(i==15){
	  infile.open ("log16.txt");
	}
	if(i==16){
	  infile.open ("log17.txt");
	}
	if(i==17){
	  infile.open ("log18.txt");
	}
	if(i==18){
	  infile.open ("log19.txt");
	}
	if(i==19){
	  infile.open ("log20.txt");
	}
	...
	if(i==20)
	{
          infile.open ("log21.txt");
        }
	if(i==21){
	  infile.open ("log22.txt");
	}
	if(i==22){
	  infile.open ("log23.txt");
	}
	if(i==23){
	  infile.open ("log24.txt");
	}
	if(i==24){
	  infile.open ("log25.txt");
	}
	if(i==25){
	  infile.open ("log26.txt");
	}
	if(i==26){
	  infile.open ("log27.txt");
	}
	if(i==27){
	  infile.open ("log28.txt");
	}
	if(i==28){
	  infile.open ("log29.txt");
	}
	if(i==29){
	  infile.open ("log30.txt");
	}
*/
