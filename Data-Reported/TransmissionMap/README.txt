...
This illustrates that some devices start sending at point 155 (after 60 million microsecs). Note that 155-121 = 34 microsecs, which is the length of a DIFS, as it should be. *All* devices attempted to transmit at 60 million microsecs, then waited till they heard silence for a DIFS, then unpaused and proceeded to the next window.
