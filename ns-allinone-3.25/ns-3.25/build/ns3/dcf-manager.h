...
public:
   ...
   */
  void ResetCw (void); 
  void ResetCw (uint32_t logVal); // This ResetCw function is used for logging***
  /**
   * Update the value of the CW variable to take into account
  ...
  void UpdateFailedCw (uint32_t logVal); // ***
  /**
  ...
  void StartBackoffNow (uint32_t nSlots, uint32_t logVal); // ***
  /**
...
private:
  ...
  */
  ...
  //EdcaTxopN::
  uint32_t m_slotsCountEdca; // (StartBackoffNow) 99? ***
  // Total
  uint32_t m_slotsCountTotal; // (StartBackoffNow) ***

  uint32_t m_accessRequestedCount; // () ***
  uint32_t m_accessGrantedCount; // (NotifyAccessGranted) ***
  uint32_t m_collisionCount; // (NotifyCollision) ***
  uint32_t m_internalCollisionCount; // (NotifyInternalCollision) ***

  int m_backoffType; // Used to choose what kind of backoff ***
  ...
  uint32_t m_whatWasCw; // ***
  int m_timesCwFailed; // ***

  uint32_t m_noMoreSlots; // ***

  bool m_countingClients; // ***
  bool m_keepPredictedCw; // ***
  uint32_t m_predictedCw; // ***
...
public:
  ...
  void NotCountingClients (void); // ***


private:

  void CountClients (void); // ***
  ...
  uint32_t m_manTxStartCount; // ***
  uint32_t m_manRxStartCount; // ***

  uint32_t m_manRxEndOkCount; // ***
  uint32_t m_manRxEndErrorCount; // ***

  bool m_carrierSensing; // ***
