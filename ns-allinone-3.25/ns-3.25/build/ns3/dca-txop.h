...
private:
  ...
  uint32_t m_ackPackets; // ***
  uint32_t m_assocReqPackets; // ***
  uint32_t m_assocRespPackets; // ***
  uint32_t m_ctsPackets; // ***
  uint32_t m_rtsPackets; // ***

  uint32_t m_dataPackets; // ***

  uint32_t m_dcaGotCtsCount; // ***
  uint32_t m_dcaMissedCtsCount; // ***
  uint32_t m_dcaGotAckCount; // ***
  uint32_t m_dcaMissedAckFailCount; // ***
  uint32_t m_dcaMissedAckRetransmitCount; // ***
  
  bool m_myQueueLogging; // ***
  bool m_myDequeueLogging; // ***
  bool m_myLowLogging; // ***
  bool m_myAckLogging; // ***

  typedef std::vector<float> floatVect; // ***
  floatVect m_ackTimeouts; // ***

  int m_curIndex; // ***

  float m_sendPacketTime; // ***
  float m_missedAckTime; // ***
  float m_totalAckTime; // ***

  float m_finalAckTime; // ***

  int m_dequeuePackets; // ***
  float m_dequeueTime; // ***
  ...
  // Variables bellow for CountClients  

  bool m_beaconStopping; // !!!
  int m_beaconStopCount; // !!!
  int m_beaconFlag; // !!!
  EventId m_countClientStart; // !!!
  int m_countStartFlag; // !!!
  double m_countClientsI; // !!!
  int m_heardNoiseFlag; // !!!
